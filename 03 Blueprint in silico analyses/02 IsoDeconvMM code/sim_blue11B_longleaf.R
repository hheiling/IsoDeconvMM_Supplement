...
# Sim11B: Run fit using 10 pure samples per cell type, truth as initial point
...
prefix_results = str_c(header_nas,"Simulation_Results/Fit11B")
...
set.seed(8500) # New set seed compared to Sims 1-5
...
# Select first 10 pure samples from each cell type
pure_ref_files = pure_ref_files_all[c(1:10,21:30,41:50),]
