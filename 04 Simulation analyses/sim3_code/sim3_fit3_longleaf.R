...
# Note: Mixture files created in "sim3_fit3_mixtures.R"
...
prefix_results = str_c(header_nas,"deconvolution/Simulation_Results/Sim3Fit3")
...
load(file = sprintf("%s/Sim3_Fit3_ProbCombos.RData", prefix_sim_out))
