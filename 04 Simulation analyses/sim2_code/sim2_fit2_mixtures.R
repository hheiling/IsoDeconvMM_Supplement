...
prefix_pure = str_c(header_pine,"Simulated_Files/Sim2_Fit2_Pure_Sample_Counts")
# Simulated mixture cell type files prefix
prefix_mix = str_c(header_pine,"Simulated_Files/Sim2_Fit2_Mixture_Sample_Counts")
...
# Determine probability combinations
## Load p_combos matrix object
## These mixture probabilities identical to the mixture probs used in Sim3 Fit3 and Sim2 Fit1
##    See p_combos creation in "sim3_code/sim3_fit3_mixtures.R"
load(sprintf("%s/ProbCombos_Mixtures50.RData",prefix_sim_out))
