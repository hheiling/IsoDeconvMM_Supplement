# Purpose of Sim 11: 
## Redo Sim 10 series with different cluster selection
## (see Parallel Selection section of Blue_IsoDetect_Results.Rmd for cluster selection details)
# Sim 11A: 5 pure samples per cell type
# 130 total clusters so more likely that 100 clusters will have WARN values 0 or 1 (not 4 or 5)
...
prefix_results = str_c(header_nas,"Simulation_Results/Fit11A")
...
}else if(clust_batch == 3){ # clusters 90-130
