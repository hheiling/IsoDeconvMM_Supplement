# Creation of mixture files for Sim 1 Fit 2 pure sample files

# Creates the mixture samples for simulation "sim1_fit2_longleaf.R"
...
prefix_pure = str_c(header_pine,"Simulated_Files/Sim3_Fit3_Pure_Sample_Counts")
# Simulated mixture cell type files prefix
prefix_mix = str_c(header_pine,"Simulated_Files/Sim3_Fit3_Mixture_Sample_Counts")
...
set.seed(1269) # Same seed as sim1_fit2_mixtures.R
...
save(p_combos, file = sprintf("%s/Sim3_Fit3_ProbCombos.RData",prefix_sim_out))
## Note: Above file later renamed as "ProbCombos_Mixtures50.RData"
## Reasoning: Decided to use same 50 mixture probabilities for Sim3_Fit3, Sim1_Fit1, and Sim1_Fit2
